...
var createAndSavePerson = function(done) {
  var onePeople = new Person({
    name: "Yittyn",
    age: 22,
    favoriteFoods: ["chicken", "burger"]
  });

  onePeople.save(function(err, data) {
...
// 'arrayOfPeople'.
var arrayOfPeople = [
  { name: "John", age: 20, favoriteFoods: ["beef", "sandwich"] },
  { name: "Mary", age: 21, favoriteFoods: ["pork", "hamburger"] }
];
